...
export default function Home() {
  ...
  return (
    <main
      className="min-h-screen bg-zinc-950 text-white px-4 sm:px-8 py-8 max-w-7xl mx-auto"
      style={{ animation: "fade-in-app 0.6s ease both" }}
    >
      {/* Header */}
      <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-white">
            which<span className="text-white/30">-</span>color
            <span className="text-white/30">-</span>do
            <span className="text-white/30">-</span>you
            <span className="text-white/30">-</span>want
          </h1>
          <p className="text-white/30 text-xs mt-0.5">
            Press{" "}
            <kbd className="bg-white/10 px-1.5 py-0.5 rounded text-white/60">R</kbd> to
            regenerate
          </p>
        </div>
